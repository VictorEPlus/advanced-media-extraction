...
public partial class MainWindow
{
    ...
    [
        ...
        new("FrameReadout", "Frame counter", "The current frame number (counting from zero), the last frame number, and the time of this frame in seconds. On the right: your in and out points and how many frames they cover.", Preview),
        new("Timeline", "Frame timeline", "Drag the white playhead to any frame. Drag the amber handles to set the in and out points; the shaded part is your selection. The ruler underneath counts frames. Left and Right step one frame, Shift steps ten.", Preview),
        ...
        new("PlayRangeButton", "Play marked range", "Plays from your in point and pauses at your out point, so you can check a selection before exporting it.", Preview),
