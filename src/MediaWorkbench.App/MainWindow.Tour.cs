...
public partial class MainWindow
{
    ...
    [
        ...
        new("CollectionsSection", "Collections", "Hand-picked lists of files from anywhere on your PC, with how many files each holds; nothing is copied or moved. Click one to show it in the workspace beside your folders.", window => { Sources(window); window.CollectionsSection.IsExpanded = true; }),
